...
class zonanoesterilController extends Controller
{
    public function index()
    {
            ...
            $testbowie      = DB::table('testbowie')->get();
    ...
    public function addNewtestbowie(Request $request)
    {
        ...
        try{
            ...
            $testbowie = new testbowie;

            $testbowie->machine_id         = $request->machine_id;
            $testbowie->lote_machine        = $request->lote_machine;
            $testbowie->date_done_bd    = $todayDate;
            $testbowie->lote_bd = $request->lote_bd;
            $testbowie->operator    = $request->operator;
            $testbowie->validation_bd    = $request->validation_bd;
            $testbowie->observation     = $request->observation;
            $testbowie->save();

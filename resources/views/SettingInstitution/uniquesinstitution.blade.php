...
@section('content')
    ...
    <div class="page-wrapper">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span> {{ $institution->institution_id }} </span>
                    </div>
                    <div class="col-sm-6">
                        <strong>Lote del Ciclo del Equipo/strong>
                        <span> {{ $institution->lote_institution }} </span>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <span> {{ $institution->lote_bd }} </span>
                    </div>

                    <div class="col-sm-6">
                        <strong>Validacion del Ciclo</strong>
                        <span> {{ $institution->validation_bd }} </span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
                        <strong>Temperatura del Esterilizador</strong>
                        <span> {{ $institution->operator }} </span>
                    </div>
                    <div class="col-sm-12">
                        <strong>Temperatura del Ambiente</strong>
                        <span> {{ $institution->observation }} </span>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12">
        ...
        @if (Auth::user()->role_name == 'Admin' || Auth::user()->role_name == 'Super Admin')
            ...
            @foreach ($institution->history as $history)
                <p>
                    <strong>ID:</strong> {{ $history->id }} <strong>Equipo:</strong> {{ $history->institution_id }},
                    <strong>Lote de equipo:</strong>: {{ $history->lote_institution }}, <strong>Lote de Insumo:</strong>: {{ $history->lote_bd }},

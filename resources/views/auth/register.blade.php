            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" placeholder="Su nombre Completos"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirmar su contraseña" required=""/>
                            </div>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="{{ route('login') }}" class="signup-image-link"><b> Ya estoy registrado</b></a>
                    </div>
                </div>
            </div>
        </section>

            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto float-right ml-auto">
                        <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_coderumed"><i class="fa fa-plus"></i> Añadir Paquetes</a>
                    </div>
                </div>
            </div>
			<!-- /Page Header -->
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <input class="form-control"  type="text" id="" name="name_coderumed" value="{{ old('name_coderumed') }}" placeholder="Ingrese la descripcion">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <label>Codigo RUMED</label>
                                    <input class="form-control" type="text" id="" name="coderumed_id" placeholder="Ingrese el codigo RUMED">
                                </div>
                            </div>
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <label>Area que pertenece</label>
                                    <input class="form-control" type="text" id="" name="area" placeholder="Ingrese el area a donde pertenece el paquete">
                                </div>
                                <div class="col-sm-6"> 
                                    <label>Categoria</label>
                                    <input class="form-control" type="text" id="" name="category" placeholder="Ingrese una categoria">
                                </div>
                            </div>
                            <br>
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    ...
                                    <input class="form-control" type="text" id="" name="detalls" placeholder="Ingrese alguna observacion">
                                </div>
                            <br>

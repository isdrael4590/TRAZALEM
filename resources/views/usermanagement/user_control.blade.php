        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Gestion de usuario</h3>
                        <ul class="breadcrumb">
            ...
            <div class="row filter-row">
                <div class="col-sm-6 col-md-3">  
                    <div class="form-group form-focus">
                        ...
                        <label class="focus-label">Nombre del usuario</label>
                    </div>
                </div>
                <div class="col-sm-6 col-md-3"> 
                    <div class="form-group form-focus select-focus">
                        ...
                        <label class="focus-label">Nombre del ROL</label>
                    </div>
                </div>
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" type="text" id="" name="name" value="{{ old('name') }}" placeholder="Ingrese su nombre">
                                    </div>
                                </div>
                                <div class="col-sm-6"> 
                                    <label>Correo Electronico</label>
                                    <input class="form-control" type="email" id="" name="email" placeholder="Ingrese su Email">
                                </div>
                            </div>
                            <div class="row"> 
                                <div class="col-sm-6"> 
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="tel" id="" name="phone" placeholder="Ingrese su telefono">
                                    </div>
                                </div>
                        ...
                        <form action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row"> 
                                <div class="col-sm-6"> 
                                    <div class="form-group">
                                        <label>Telefono</label>
                                        <input class="form-control" type="text" id="e_phone_number" name="phone" placeholder="Ingrese su telefono">
                                    </div>
                                </div>

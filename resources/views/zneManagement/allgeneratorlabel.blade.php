                                ...
                                <div class="labelqr-action">
                                    ...
                                    <div class="labelqr-row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input class="form-control" type="text" id="e_lote_machine"
                                    ...
                                    <div class="labelqr-row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('start_date') }}"id="fecha_elaboracion">
                                ...
                                <div class="labelqr-header">
                                    ...
                                    <div class="labelqr-action">
                                        <button class="btn btn-sm btn-primary" type="button" data-toggle="modal"
                                            data-target="#add_custom_package"><i class="fa fa-plus"></i> INSERTAR
                                            PAQUETES</button>
                                    </div>
                                </div>
                                            ...
                                            @foreach ($temporarycoderumed as $key => $temp_coderumed)
                                                <tr>
                                                    ...
                                                    <td class="form-group form-focus select-focus">
                                                        ...
                                                        <select class="select floating" id="cantidad_paq"
                                                            name="label_number">
                                                        ...
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                <a href="#" class="dropdown-item"
                                                                    data-toggle="modal"
                                                                    data-target="#delete_temporary_coderumed"><i
                            ...
                            <div class="form-group labelqr-duallist">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-sm-5" class="table-responsive">
                                        <select name="package_rumed_from" id="package_rumed_select" class="form-control"
                                            size="5" multiple="multiple">
                                            @foreach ($coderumedselect as $key => $itemrumed)
                                                <option value="{{ $itemrumed->coderumed_id }}">
                                                    {{ $itemrumed->coderumed_id }} ==> {{ $itemrumed->name_coderumed }}
                                                </option>
                                            @endforeach
                                    ...
                                    <div class="multiselect-controls col-lg-2 col-sm-2">
                                        <button type="button" id="package_rumed_select_rightAll"
                                            class="btn btn-block btn-white"><i class="fa fa-forward"></i></button>
                                        <button type="button" id="package_rumed_select_rightSelected"
                                            class="btn btn-block btn-white"><i class="fa fa-chevron-right"></i></button>
                                        <button type="button" id="package_rumed_select_leftSelected"
                                            class="btn btn-block btn-white"><i class="fa fa-chevron-left"></i></button>
                                        <button type="button" id="package_rumed_select_leftAll"
                                            class="btn btn-block btn-white"><i class="fa fa-backward"></i></button>
                                    </div>
                                    <div class="col-lg-5 col-sm-5">
                                        <select name="package_rumed_to" id="package_rumed_select_to" class="form-control"

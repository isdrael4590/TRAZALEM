                            ...
                            <div class="col-md-20">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        Productos o Paquetes de Instrumental.
                                    </div>
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-40">
                                ...
                                <div class="card mb-12">
                                    <div class="carb-body">
                                        <!-- Annual labelqr -->
                                        <form action="{{ route('generatorqr.store') }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @enderror
                                                    <div class="form-group form-focus select-focus">
                                                        <select class="select floating" id="temp_machine"
                                                            name="temp_machine">
                                                            <option selected disabled>-- Sleccionar la Temperatura del
                                                                Ciclo--
                                                            </option>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @enderror
                                                    <div class="form-group form-focus select-focus">
                                                        <select class="select floating" id="type_program"
                                                            name="type_program">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @enderror
                                                    <input class="form-control" type="text" id="lote_biologic"
                                                        name="lote_biologic"
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" type="text" id="operator"
                                                        name="operator" placeholder= "{{ Auth::user()->name }}"
                                                        value="{{ Auth::user()->name }}">
                                                </div>
                                            </div>

                                            <livewire:coderumed-cart :cartInstance="'generatorqr'"/>

                                            <div class="submit-section">
                                                <button class="btn btn-primary submit-btn m-r-10"> {{ __('Crear Etiqueta') }}</button>
